...
- Next is upgraded to 15.5.20. Its nested PostCSS still has two moderate `npm audit` findings with no safe fix; the app does not compile user-supplied CSS, so no dependency override is forced.
