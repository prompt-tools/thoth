...
const RULES: BriefRule[] = [
  ...
  { dimension: "pose", pattern: /双腿站稳|坐在|奔向|冲过|回眸|行走|站着/, material: (value) => value !== "站着" },
  { dimension: "character_interaction", pattern: /牵(?:着|手)|拥抱|对视|看向窗外|第一人称互动/ },
  { dimension: "scene", pattern: /白色背景|白底|教室窗边|暴风雨甲板|雨夜霓虹巷|魔法森林|背景|场景/, material: (value) => !/白色背景|白底/.test(value) },
  { dimension: "camera_angle", pattern: /低机位|高机位|平视|俯视|仰视|第一人称视角/ },
  ...
  { dimension: "lighting", pattern: /午后阳光|电影光效|柔光|逆光|侧光|光线|光效/ },
  ...
  { dimension: "mood", pattern: /史诗紧张氛围|紧张感|温柔心动|正式可信|干练但?亲和|春日氛围|极简高级|强烈速度感|自然温暖|氛围/ },
