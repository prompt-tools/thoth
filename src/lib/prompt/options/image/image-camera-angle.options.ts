...
/** 机位 / 视角 — where the camera is and lens viewpoint (angle, POV, lens
 *  distortion). Split out of legacy `image_perspective` (Slice 2 / Phase A);
 *  the 4 shot-size options moved to image_framing. Prototype-only.
 *  Lens focal length / depth of field will live in the future image_camera dim. */
export const imageCameraAngleOptions: OptionSet = {
  id: "image_camera_angle",
  version: "0.1.0",
  label: { zh: "机位/视角", en: "Camera angle / viewpoint" },
  categories: [
    {
      id: "cat:image_camera_angle:angle",
      label: { zh: "拍摄角度", en: "Camera angle" },
      optionIds: [
        "image_camera_angle:eye_level", "image_camera_angle:top_down", "image_camera_angle:aerial_view",
        "image_camera_angle:low_angle", "image_camera_angle:slight_low_angle", "image_camera_angle:slight_high_angle",
        "image_camera_angle:isometric_view", "image_camera_angle:dutch_angle"
      ]
    },
    {
      id: "cat:image_camera_angle:viewpoint",
      label: { zh: "视点/镜头", en: "Viewpoint / lens" },
      optionIds: [
        "image_camera_angle:fisheye", "image_camera_angle:macro_view",
        "image_camera_angle:first_person", "image_camera_angle:over_the_shoulder"
      ]
    }
  ],
  options: [
    {
      id: "image_camera_angle:eye_level",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:top_down",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:aerial_view",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:low_angle",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:slight_low_angle",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:slight_high_angle",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:isometric_view",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:dutch_angle",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:macro_view",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:first_person",
      version: "0.1.0",
    ...
    {
      id: "image_camera_angle:over_the_shoulder",
      version: "0.1.0",
